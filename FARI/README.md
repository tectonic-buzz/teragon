...
Pierwszy zestaw sprawdza skończone przykłady, nie dowodzi RH. Drugi certyfikuje pierwszość jednej wskazanej liczby. Trzeci zawiera cztery kontrole numeryczne do komentarzy w FARI: liczność sita, sumę dwiema drogami i dwa odczyty pochodnej ζ.
...
- [Seria Firoozbakht](1187_Firoozbakht_seria.md) i [Cenzus ζ′](1217_Cenzus_ζ′.md) — oryginalne notatki robocze z oddzielonymi komentarzami po weryfikacji; rachunki komentarzy odtwarza [check_pol_notes.py](tests/check_pol_notes.py).
